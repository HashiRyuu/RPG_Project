...
int main() {
   ...
   // Initialize FontManager with the path to the font file
    FontManager fontManager("/Users/hashi/Desktop/GAME/ProjectHack/character/character/Font/Planes_ValMore.ttf");
    ...
    HealthBar healthBar(1000, 600.f, 20.f, sf::Vector2f(200.f, 50.f));
    ...
    // Load and play music
    try {
      musicManager.playBackgroundMusic("/Users/hashi/Desktop/GAME/ProjectHack/Music/pixel-song-27-72476.ogg", 80.f, true);
    ...
    if (!coinTexture.loadFromFile("/Users/hashi/Desktop/GAME/ProjectHack/map/coin.png")) {
        return -1;
    }
    ...
    if (!enemyTexture.loadFromFile("/Users/hashi/Desktop/GAME/ProjectHack/character/character/2 Owlet_Monster/Owlet_Monster_Walk_6.png")) {
        return -1; // Error loading texture
    }

    if (!enemyTexture2.loadFromFile("/Users/hashi/Desktop/GAME/ProjectHack/character/character/2 Owlet_Monster/Owlet_Monster_Walk_6.png")) {
        return -1; // Error loading texture
    }

    if (!kiwi.loadFromFile("/Users/hashi/Desktop/GAME/ProjectHack/character/character/1 Pink_Monster/Pink_Monster_Walk+Attack_6.png")) {
        return -1; // Error loading texture
    }
    ...
    if (!walkTexture.loadFromFile("/Users/hashi/Desktop/GAME/ProjectHack/character/character/3 Dude_Monster/Dude_Monster_Walk_6.png")) {
        return -1;
    }

    if (!idleTexture.loadFromFile("/Users/hashi/Desktop/GAME/ProjectHack/character/character/3 Dude_Monster/Dude_Monster_Idle_4.png")) {
        return -1;
    }


    if (!attackTexture.loadFromFile("/Users/hashi/Desktop/GAME/ProjectHack/character/Attack2.png")) {
        return -1;
    }
...
while (window.isOpen()) {
	...
	// Check and enforce boundaries for kiwi
        ...
        if (playerAnimation.getSprite().getGlobalBounds().intersects(coinSprite.getGlobalBounds())) {
            ...
            try {
                   musicManager.playCoinSound("/Users/hashi/Desktop/GAME/ProjectHack/Music/coin-257878.ogg");
                } catch (const std::exception& e) {
...
if (click) {
   ...
   if ((playerBounds.intersects(enemy1Bounds) || playerBounds.intersects(enemy2Bounds)) && checkNewMap) {
        // Handle collision with enemies (e.g., eliminate enemies)
        score += 1;
    }

    if (playerBounds.intersects(kiwiBounds) && !checkNewMap) {
